...
data = rekreasi['jenis_usaha'].value_counts()
...
ax.xaxis.set_ticks([i * 20 for i in range(0, 15)])
ax.xaxis.set_ticklabels([i * 20 for i in range(0, 15)], size=16, fontweight=100)
...
# Add subtitle
fig.text(
    0, 0.875, "Banyaknya Jenis Usaha yang ada di Jakarta", 
    fontsize=20
)
